...
function computedWithControl(source, fn) {
  ...
  const get2 = isFunction3(fn) ? fn : fn.get;
  const set3 = isFunction3(fn) ? void 0 : fn.set;
  ...
  setup(__props) {
    ...
    const style = computed(() => {
      ...
      if (!size2 && !color)
        return {};
      return {
        fontSize: isUndefined2(size2) ? void 0 : addUnit(size2),
        "--color": color
      };
    });
    return (_ctx, _cache) => {
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RAO4OMMW.js.map
